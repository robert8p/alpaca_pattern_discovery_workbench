...
CREATE TABLE IF NOT EXISTS ra_point_in_time_universe_snapshots (
    ...
    availability_reference_date date,
    availability_removed_symbols integer NOT NULL DEFAULT 0,
    availability_refilled_symbols integer NOT NULL DEFAULT 0,
    availability_method_version text,
